...
class Yuki(commands.Cog):
    ...
    async def info(self, ctx):
        ...
        embed = discord.Embed(title="Sobre mim", colour=discord.Colour(0x00ff11),description=f"{ctx.author.mention} sou apenas um bot para interação no discord, fui desenvolvivo em python. Contenho funções para interação e limpar o chat!\nQue tal olhar meu código fonte no github?\nurl:https://github.com/VL0511/Yuki_bot\n artista da imagem: @ZenX#7728", timestamp=datetime.utcnow())
